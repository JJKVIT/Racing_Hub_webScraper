...
with open("F2\Calender\Race Calendar.txt",'w') as schedule:
    ...
    basic_info_list=list(zip(date_start_list,date_end_list,month_list,location_list))
...
for timings in time_driver_class:
    time_driver_list.append(timings.text) #Gives all the output including time space gap etc
