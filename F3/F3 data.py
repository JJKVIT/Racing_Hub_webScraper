...
with open("Racing_Hub\F3\Standings\Team Standings.txt", 'w') as f3drivers:
...
with open("Racing_Hub\F3\Standings\Team Standings.txt", 'w') as f3team:
...
with open("Racing_Hub\F3\Calendar\F3 Calendar.txt", 'w') as f3calendar:
